...
export function MemorySubmissionForm() {
  ...
  return <form className="form-stack" aria-label="স্মৃতি জমাদান" onSubmit={submit}>
    ...
    <button className="button button-accent" type="submit" disabled={!configured}>{configured ? "নিরাপদে জমা দিন" : "নিরাপদ জমাদান শিগগিরই"}</button>

...
export function AdminModerationDashboard() {
  ...
  return <div className="moderation-dashboard">
    ...
    {message && <div className="notice" role="status">{message}{message.includes("Cloudflare Access") && <>{" "}<a href={`${endpoint}/health`} target="_blank" rel="noreferrer">Open secure editor sign-in</a>, then return here and refresh.</>}</div>}
